...
P = dict(leaf_min_z=1.2, trunk_len=3.3, trunk_r=0.1, flare=0.35, card=0.5, bark_tile=0.45, fold=0.1, droop=0.35, nblend=0.72, card_up=-0.2,
         levels=[
             ...
             dict(n=(5, 6), t0=0.2, t1=1.0, angle=45, ratio=0.6, shrink=0.3, rratio=0.6, sides=3, droop=0.18, wiggle=0.14, taper=0.35, cards=4, card_t0=0.3, seg=0.18),
             dict(n=(2, 3), t0=0.3, t1=1.0, angle=35, ratio=0.6, shrink=0.2, rratio=0.6, rmin=0.004, sides=3, droop=0.35, wiggle=0.12, taper=0.4, cards=5, card_t0=0.05, seg=0.15),
         ])
