# Ornate dark-walnut and gilt-lip frame 50x40 with seascape. Back at -Z (wall).
import sys; sys.path.insert(0, __import__('os').path.dirname(__import__('os').path.abspath(__file__)))
import helpers as H, _kit as K, _photo
from helpers import V, PI
import math
H.reset()
frame = K.wood('fancy_walnut', light='#6e4c34', mid='#553a27', dark='#34231a', seed=143, coat=0.3)
mount = K.plain('hang_mount', '#f4f0e6', 0.9)
glass = H.pbr('hang_glass', '#ffffff', 0.03, alpha=0.1, spec=0.9, blend='BLEND')
img = _photo.photo('picture_frame_fancy_02_art', 1, W=512, Hh=384, seed=15)
art = H.pbr('art_print', '#ffffff', 0.6, base_tex=img)
W, Hh, F, T, M = 0.5, 0.4, 0.06, 0.045, 0.0
...
H.finish('picture_frame_fancy_02', extras={'texres': 512})
