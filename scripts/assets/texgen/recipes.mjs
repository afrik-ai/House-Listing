...
export const RECIPES = {
  ...
  concrete_smooth_light: (px, e) => ({ t: concrete(px, e, { col: lin('#bdbbb5'), cloud: 0.16, agg: 0.015, speck: 0.0, poreDensity: 0.03, poreCellMM: 10, poreSize: 0.35, rough: 0.8, burnR: 0.1, burnC: 0.0, wave: 0.03 }), mm: S(e) / px, opts: { meanLum: 0.48 } }),
  asphalt: (px, e) => {
