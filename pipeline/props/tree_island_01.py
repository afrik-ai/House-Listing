...
P = dict(trunk_len=1.55, trunk_r=0.13, flare=0.5, card=0.62, bark_tile=0.5, fold=0.14, droop=0.15, nblend=0.72, card_up=0.35,
         levels=[
             ...
             dict(n=(5, 7), t0=0.2, t1=1.0, angle=55, ratio=0.55, shrink=0.35, rratio=0.6, rmin=0.005, sides=3, droop=0.08, wiggle=0.18, taper=0.4, cards=4, card_t0=0.1, seg=0.2),
         ])
